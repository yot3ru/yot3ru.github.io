...
4. **Studio pieces** proves the claim. Desktop and tablet advance one project
   ...
   editorial spread: a dominant 16:10 landscape image on the main column and
   a restrained marginal note separated by deliberate negative space.
...
The inline page gutter is fluid: `clamp(1.25rem, 5vw, 6rem)`. It is shared by
the chapter content, the work rail, and the hero cue. The reading measure is
capped at 68ch; display headings may be wider, but explanatory copy does not
...
strip. At mobile widths, the work rail remains a horizontal, one-page-per-swipe
sequence while all other content stays in the vertical chapter flow.
